              ...
              data: (records) {
                ...
                return Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('Present: $present | Late: $lateCount', style: const TextStyle(fontWeight: FontWeight.bold)),
                    ),
                    Expanded(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            child: ListTile(
                              ...
                              subtitle: Text('Check-In: ${record.checkIn != null ? timeFormat.format(record.checkIn!) : "--"}\nCheck-Out: ${record.checkOut != null ? timeFormat.format(record.checkOut!) : "--"}\nHours: ${record.workingHours}'),
